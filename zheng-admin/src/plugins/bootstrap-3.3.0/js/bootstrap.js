...
+function ($) {
    ...
    var Collapse = function (element, options) {
        ...
        this.$trigger =
            $(this.options.trigger).filter('[href="#' + element.id + '"], [data-target="#' + element.id + '"]')
...
+function ($) {
    ...
    $(document).on('click.bs.modal.data-api', '[data-toggle="modal"]', function (e) {
        ...
        var option = $target.data('bs.modal') ? 'toggle' : $.extend({remote: !/#/.test(href) && href}, $target.data(),
                                                                    $this.data())
    ...
    Tooltip.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (autoPlace) {
                ...
                placement =
                    placement == 'bottom' && pos.bottom + actualHeight > containerDim.bottom ? 'top' : placement
                                                                                                       == 'top'
                                                                                                       && pos.top
                                                                                                          - actualHeight
                                                                                                          < containerDim.top
                        ? 'bottom' : placement == 'right' && pos.right + actualWidth > containerDim.width ? 'left'
                                                                                                           : placement
                                                                                                             == 'left'
                                                                                                             && pos.left
                                                                                                                - actualWidth
